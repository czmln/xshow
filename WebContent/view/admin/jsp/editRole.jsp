...
<html>
  <head>
	...
	<title>角色修改</title>
	<script type="text/javascript" src="<%=path%>/view/admin/js/editRole.js"></script>
	<style type="text/css">
		.datafrom{
		width:95%;
		}
	...
	<div data-options="region:'center',border:false" style="background:#fff;">
    	<form id="easy-dataform"  name="easy-dataform"  method="post" target="_self"  style="padding:0 10px 10px 10px;">
    		...
    		<fieldset style="margin: 5px;">
				<legend style="font-weight:bold;">角色数据</legend>
		    	<table class="datafrom" style="width:95%;">
			    		<tr>
			    			<td class="td_head">角&ensp;色&ensp;名: <span style="color:red;">*</span></td>
							<td><input class="easyui-validatebox" id="roleName" type="text" name="roleName" required="true" validType="maxLength[60]" style="width:148px;" value="${demo.roleName}"></input></td>
			    		</tr>
